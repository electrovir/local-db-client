...
import {LocalDbClient} from './local-db.client.js';
...
describe(LocalDbClient.name, () => {
    async function createTestClient() {
        ...
        const testClient = new LocalDbClient(testShapes, {storeName});
    ...
    it('uses default store name when not provided', () => {
        const testClient = new LocalDbClient(testShapes);
    ...
    it('throws error when shapes object has non-string keys', () => {
        assert.throws(
            () =>
                new LocalDbClient({
    ...
    it('isolates store names', async () => {
        ...
        assert.strictEquals(await testClient1.get.stringValue(), 'from client 1');
        assert.strictEquals(await testClient2.get.stringValue(), 'from client 2');
    });

    it('same store name shares storage', async () => {
        const {testClient: testClient1} = await createTestClient();
        const testClient2 = new LocalDbClient(testShapes, {storeName: testClient1.storeName});

        await testClient1.set.stringValue('shared value');

        assert.strictEquals(await testClient2.get.stringValue(), 'shared value');
    });
    ...
    describe('set', () => {
        it('stores a string value', async () => {
            ...
            assert.strictEquals(await testClient.get.stringValue(), 'hello world');
        });
        ...
        it('stores a number value', async () => {
            ...
            assert.strictEquals(await testClient.get.numberValue(), 123);
        });
        ...
        it('stores a boolean value', async () => {
            ...
            assert.strictEquals(await testClient.get.booleanValue(), false);
        });
        ...
        it('stores an object value', async () => {
            ...
            assert.deepEquals(await testClient.get.objectValue(), objectValue);
        });
        ...
        it('stores an array value', async () => {
            ...
            assert.deepEquals(await testClient.get.arrayValue(), arrayValue);
        });
        ...
        it('stores a nested object value', async () => {
            ...
            assert.deepEquals(await testClient.get.nestedValue(), nestedValue);
        });
        ...
        it('preserves existing values when setting a new one', async () => {
            ...
            assert.strictEquals(await testClient.get.stringValue(), 'first');
            assert.strictEquals(await testClient.get.numberValue(), 999);
        });
        ...
        it('overwrites existing value with same key', async () => {
            ...
            assert.strictEquals(await testClient.get.stringValue(), 'updated');
        });
        ...
        it('allows extra keys in objects', async () => {
            ...
            assert.deepEquals(await testClient.get.objectValue(), objectWithExtra);
        });
        ...
        it('handles empty string values', async () => {
            ...
            assert.strictEquals(await testClient.get.stringValue(), '');
        });
        ...
        it('handles zero number values', async () => {
            ...
            assert.strictEquals(await testClient.get.numberValue(), 0);
        });
        ...
        it('handles empty array values', async () => {
            ...
            assert.deepEquals(await testClient.get.arrayValue(), []);
        });
        ...
        it('handles empty object with required shape properties', async () => {
            ...
            assert.deepEquals(await testClient.get.objectValue(), value);
        });
        ...
        it('handles negative numbers', async () => {
            ...
            assert.strictEquals(await testClient.get.numberValue(), -42);
        });
        ...
        it('handles floating point numbers', async () => {
            ...
            assert.strictEquals(await testClient.get.numberValue(), 3.14);
        });
        ...
        it('handles special string characters', async () => {
            ...
            assert.strictEquals(await testClient.get.stringValue(), specialString);
        });
        ...
        it('handles unicode strings', async () => {
            ...
            assert.strictEquals(await testClient.get.stringValue(), unicodeString);
        });
    });
    ...
    describe('get', () => {
        it('returns undefined for non-existent key', async () => {
            ...
            const result = await testClient.get.stringValue();
        ...
        it('retrieves a stored number value', async () => {
            ...
            const result = await testClient.get.numberValue();
        ...
        it('retrieves a stored boolean value', async () => {
            ...
            await testClient.set.booleanValue(false);
            const result = await testClient.get.booleanValue();
        ...
        it('retrieves a stored object value', async () => {
            ...
            await testClient.set.objectValue(objectValue);
            const result = await testClient.get.objectValue();
        ...
        it('retrieves a stored array value', async () => {
            ...
            await testClient.set.arrayValue(arrayValue);
            const result = await testClient.get.arrayValue();
        ...
        it('retrieves a stored nested object value', async () => {
            ...
            await testClient.set.nestedValue(nestedValue);
            const result = await testClient.get.nestedValue();
        ...
        it('gets undefined for an unset key', async () => {
            ...
            assert.isUndefined(
                await testClient.get.stringValue({
        ...
        it('returns valid value', async () => {
            ...
            assert.strictEquals(
                await testClient.get.stringValue({throwErrorOnFailure: true}),
                'valid',
            );
        });
        ...
        it('ignores invalid value', async () => {
            ...
            assert.isUndefined(await testClient.get.stringValue());
        });

        it('deletes when setting to undefined', async () => {
            const {testClient} = await createTestClient();
            await testClient.set.stringValue('hi');
            assert.deepEquals(await testClient.getAllValues(), {
                stringValue: 'hi',
            });
    ...
    describe('delete', () => {
        ...
        it('does not affect other stored values', async () => {
            ...
            assert.strictEquals(await testClient.get.stringValue(), 'keep me');
            assert.isUndefined(await testClient.get.numberValue());
        });
    ...
    describe('getAllValues', () => {
        it('returns empty object when storage is empty', async () => {
            ...
            const result = await testClient.getAllValues();
        ...
        it('throws error on invalid shape when throwErrorOnFailure is true', async () => {
            ...
            const result = await testClient.getAllValues({throwErrorOnFailure: true});
            assert.strictEquals(result.stringValue, 'valid');
        });
        ...
        it('ignores keys in storage that have no shape definition', async () => {
            ...
            assert.strictEquals(await testClient.get.stringValue(), validValue);
        ...
        it('can throws error in getAllValues', async () => {
            const {testClient, localForage} = await createTestClient();

            await localForage.setItem('stringValue', 12_345); // should be a string

            await assert.throws(() => testClient.getAllValues({throwErrorOnFailure: true}), {
                matchMessage: "Invalid value at key 'stringValue'",
            });
        });

        it('excludes invalid values in getAllValues when throwErrorOnFailure is false', async () => {
            const {testClient, localForage} = await createTestClient();
